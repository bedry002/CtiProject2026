...
class ScoringWeights:
    # Rebalanced after dropping BERTopic: the 0.20 topic share was
    # redistributed toward sbom (+0.10) and keyword (+0.10) — the two
    # strongest discriminators for a profile-targeted feed.
    sbom:       float = 0.45  # SBOM component hits — most precise signal
    keyword:    float = 0.35  # SBOM-derived compound phrase matches
